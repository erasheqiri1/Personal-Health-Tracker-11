// // app/admin/ushtrime/homeworkout.jsx
...
export default function HomeWorkoutAdmin() {
  ...
  const handleSave = async () => {
    ...
    const iconTrimmed = icon.trim(); // mundet me qenë bosh, nuk është e detyrueshme
    ...
    <View style={s.container}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        <TextInput
          ...
          placeholder="Ikona (p.sh. run-fast, yoga, dumbbell...)"
          value={icon}
