...
//   },
// });
// app/admin/ushtrime/weightlifting.jsx
...
// ky file është për planin "Weightlifting"
const PLAN_KEY = 'weightlifting';
...
export default function WeightliftingAdmin() {
  ...
  const [subtitle, setSubtitle] = useState('');
  const [calories, setCalories] = useState('');
  const [icon, setIcon] = useState('');            // emri i ikonës
  const [editingId, setEditingId] = useState(null);
  ...
  // READ – leximi i ushtrimeve për planin "weightlifting"
  useEffect(() => {
    setLoading(true);
  ...
  return (
    <View style={s.container}>
      ...
      <Text style={s.header}>Ushtrimet e planit: Weightlifting</Text>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        <TextInput
          ...
          placeholder="Ikona (p.sh. dumbbell, weight-lifter, run-fast...)"
          value={icon}
